...
interface ReadingDetailsScreenProps {
    navigation: StackNavigationProp<PDNavStackParamList, 'ReadingDetails'>;
    route: RouteProp<PDNavStackParamList, 'ReadingDetails'>;
}
...
export class ReadingDetailsScreen extends React.Component<ReadingDetailsScreenProps, ReadingDetailsScreenState> {
    ...
    constructor(props: ReadingDetailsScreenProps) {
        ...
        this.entry = this.props.route.params.readingEntry;
        this.reading = this.props.route.params.reading;
