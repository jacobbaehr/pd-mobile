...
interface ConfirmPurchaseProps {
    /**  */
    navigation: StackNavigationProp<PDNavStackParamList, 'ConfirmPurchase'>;
    route: RouteProp<PDNavStackParamList, 'ConfirmPurchase'>;
    /** */
    user: User | null;
}
...
class ConfirmPurchaseComponent extends React.PureComponent<ConfirmPurchaseCombinedProps> {
    ...
    render() {
        ...
        // const prevScreen = this.props.route.params.prevScreen;
        // const backgroundImage =
        //     prevScreen === 'Authentication'
        //         ? images.greenAuthenticationBackground
        //         : images.blueAuthenticationBackground;
        // const screenThemeColor = prevScreen === 'Authentication' ? '#00c89f' : '#50b4ff';
        const screenThemeColor = '#50b4ff';
