    ...
    return (
        <NavigationContainer>
            <RootStack.Navigator
                ...
                <RootStack.Screen name="PDEditPoolNavigator" component={ PDEditPoolNavigator } />
            </RootStack.Navigator>
        </NavigationContainer>
    );
};
