...
const masked_view_1 = require("@react-native-community/masked-view");
// @ts-ignore
...
class PDGradientText extends React.Component {
    getText() {
        ...
        return (React.createElement(react_native_1.View, { style: { flexDirection: 'row' } },
            React.createElement(masked_view_1.default, { maskElement: React.createElement(react_native_1.Text, { style: textStyle }, this.props.children) },
